...
time.sleep(2)
#os.system('clear')
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mUPDATE VERSHON 8.0V...! ')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/atik-lx/approval./commit/d6cfe235ea5d340a687659a3fc78189df647025e?diff=unified').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/atik-lx/approval./commit/d6cfe235ea5d340a687659a3fc78189df647025e?diff=unified').text
        ua=open('bbnew.txt','w')
...
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://github.com/atik-lx/approval./commit/d6cfe235ea5d340a687659a3fc78189df647025e?diff=unified')
logo =(f"""
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL VIRSION\033[1;91m :  \033[1;35m[\033[1;32m\033[1;92m8.0\033[1;35m]                       \033[1;91m|
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
  ...
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('https://github.com/atik-lx/approval./commit/d6cfe235ea5d340a687659a3fc78189df647025e?diff=unified='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  ATIK,  V I P,  Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'ASHIK' and password == '80':
